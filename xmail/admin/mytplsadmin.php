...
include_once XOOPS_ROOT_PATH.'/modules/xmail/include/gtickets.php' ;
include_once XOOPS_ROOT_PATH.'/class/template.php';

	$xoopsConfig['language'] = preg_replace("/[^0-9a-z\-_,]+/i", "", $xoopsConfig['language']);
		if ( file_exists(XOOPS_ROOT_PATH."/modules/xmail/language/".$xoopsConfig['language']."/mytpladmin.php") ) {
		include XOOPS_ROOT_PATH."/modules/xmail/language/".$xoopsConfig['language']."/mytpladmin.php";
	} else {
		include XOOPS_ROOT_PATH."/modules/xmail/language/english/mytpladmin.php";
	}
