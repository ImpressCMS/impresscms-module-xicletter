<?php
// $Id: themeformflat.php,v 1.1 2006/02/17 20:37:33 claudia Exp $
//  ------------------------------------------------------------------------ //
 ...
 * @subpackage  form
 */
class XoopsThemeFormFlat extends XoopsForm
{
	/**
	...
	function insertBreak($extra = '', $class= '')
	{
		...
		if ($extra) {
			$extra = "<tr><td $class>$extra</td></tr>";
			$this->addElement($extra);
		} else {
			$extra = "<tr><td $class>&nbsp;</td></tr>";
			$this->addElement($extra);
		}
	}
