...
?>
	...
	<body>
	<br /><br /><div style='text-align:center'><img src='images/logo-xmail.png' /><h4>XMAIL Upgrade</h4>
<?php
}
...
$count = 0;
    ...
    $sql="ALTER TABLE ".$xoopsDB->prefix("xmail_param")." ADD dir_upload varchar(255)  NOT NULL default '/uploads/xmail' " ;
