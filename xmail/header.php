...
// checar se user � admin
//	$xoopsModule = XoopsModule::getByDirname($modversion['dirname']);
// acima n�o deu certo pois n�o reconhece $modversion  -  verificar qual melhor forma de fazer
//  sem colocar explicitamente  xmail  e sim resgatar com fun��o
