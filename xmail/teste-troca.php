<?php
// teste-troca.php
// autor: Claudia Antonini Vitiello Callegari
// Objetivo: Trocar strings nos arquivos do diretório onde esta este script e no subdiretórios também
// A matriz $origem deve conter a string original  e $destino deve conter a nova string.
// Definir em $ext_valid as extensões de arquivos válidas para pesquisar
// $arq_log  -> nome do arquivo para registrar o log da pesquisa
// $faz_troca  ->  pode ser true ou false  indicando se fará a troca ou somente irá localizar, gerando o log
// $case_sensitive -> pode ser true ou false indica se usará função ereg_replace (true) ou eregi_replace( false)
// $extension   -> se definido irá gerar outro arquivo com extensão diferente
// $gravalog  ->  true ou fase . Indica se gravará arquivo de log ou não


set_time_limit(0);
// troca.php

echo " dei return  para não executar por segurança,  edit o script e comente esta linha ...  ";
return;

//  Não usar asteriscos (*) na matriz $origem
$origem[]= '\$HTTP_GET_VARS';
$destino[]= '$_GET'; 


$origem[]= '\$HTTP_POST_VARS';
$destino[]= '$_POST'; // colocar aqui as siglas do novo módulo  em minúsculo
