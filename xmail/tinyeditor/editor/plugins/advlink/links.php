    ...
    <form onsubmit="insertAction();return false;" action="#">
		<div class="tabs">
			<ul>
				...
				<li id="xoops_tab"><span><a href="javascript:mcTabs.displayTab('xoops_tab','xoops_panel');" onmousedown="return false;">{$lang_advlink_xoops_tab}</a></span></li>
			</ul>
		</div>
		...
		<div class="panel_wrapper">
			...
			<div id="xoops_panel" class="panel">

          <fieldset><legend><strong>{$lang_advlink_insert_link_toptitle}</strong></legend>
<table border="0"><?php $path = XOOPS_ROOT_PATH."/modules/tinyeditor/editor/plugins/advlink/plugins";
