...
function CtxMenu1(id) {
    ...
    /* Initialize the menu */
    this.init = function() {
        if (!document.getElementById(this.id)) { return alert("CtxMenu1.init() failed. Element '"+ this.id +"' does not exist."); }
        if (this.type != "horizontal" && this.type != "vertical") { return alert("CtxMenu1.init() failed. Unknown menu type: '"+this.type+"'"); }
    ...
    this.hideSection = function(id, cnt) {
        ...
        if (id == this.visible) { this.visible = ""; }
            ...
            //throw "CtxMenu1.hideSection('"+id+"', "+cnt+") failed, cannot hide element that is not visible";
            return;
        }
