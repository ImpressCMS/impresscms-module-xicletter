 ...
 * @version $Id: editor.js,v 1.1 2006/04/08 14:37:31 frankblacksf Exp $
 ...
 */
        ...
        function toggle(action)
        {
                if(current_action != action)
                {
                        ...
                        indicator.src = '../images/editor/'+action+'.gif';
        ...
        function toggleMarker()
        {
                ...
                if(marker != null && marker.src != null) {
                        if(marker.src.indexOf("t_black.gif") >= 0)
                                marker.src = "../images/editor/t_white.gif";
                        else
                                marker.src = "../images/editor/t_black.gif";
        ...
        function toggleConstraints()
        {
                ...
                if(lock != null && lock.src != null) {
                        ...
                        {
                                lock.src = "../images/editor/islocked2.gif";
                        ...
                        {
                                lock.src = "../images/editor/unlocked2.gif";
