...
//
//
// $Id: GD.php,v 1.1 2006/04/08 15:09:32 frankblacksf Exp $
//
...
//
	...
	function addText($params) {
        ...
        if (!is_array($params['color'])) {
            if ($params['color'][0]=='#'){
                $this->colorhex2colorarray( $params['color'] );
            } else {
                include_once XOOPS_ROOT_PATH.'/modules/tinyeditor/class/ColorsDefs.php';
        ...
        if ('ttf' == substr($params['font'], -3)) {
            ImageTTFText($this->imageHandle, $params['size'], $params['angle'], $params['x'], $params['y'], $c, $params['font'], $params['text']);
        } else {
            ImagePSText($this->imageHandle, $params['size'], $params['angle'], $params['x'], $params['y'], $c, $params['font'], $params['text']);
        }
        return true;
    } // End addText
    ...
    function rotate($angle, $options=null)
    {
        ...
        if( !is_array($color_mask) ){
            if ($color[0]=='#'){
                ...
                include_once XOOPS_ROOT_PATH.'/modules/tinyeditor/class/ColorDefs.php';
