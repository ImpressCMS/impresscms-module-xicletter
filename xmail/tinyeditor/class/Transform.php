...
// +----------------------------------------------------------------------+
//
// $Id: Transform.php,v 1.1 2006/04/08 15:09:32 frankblacksf Exp $
//
...
class Image_Transform {
    ...
    function &factory($driver) {
		...
		// overcautious? Filtering the driver variable
		$regex = '#\.\.|[^A-Za-z0-9\.\_\- ]#';
		$driver = preg_replace($regex, '', $driver) ;
		$driver = str_replace(' ', '_', $driver);

		include_once XOOPS_ROOT_PATH."/modules/tinyeditor/class/$driver.php";
