...
// +----------------------------------------------------------------------+
//
// $Id: IM.php,v 1.1 2006/04/08 15:09:32 frankblacksf Exp $
//
...
//
	...
	function addText($params) {
		$default_params = array('text' => 'This is Text', 'x' => 10, 'y' => 20, 'color' => 'red', 'font' => 'Arial.ttf', 'resize_first' => false); // Carry out the scaling of the image before annotation?
		$params = array_merge($default_params, $params);
         //extract($params);
		if (true === $params['resize_first']) {
